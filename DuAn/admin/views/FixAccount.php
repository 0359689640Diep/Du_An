    ...
    <section class="page">
        ...
        <main>
            <form action="index.php?controller=FixAccount" method="post" enctype="multipart/form-data">
                ...
                <input value="<?php echo $data['display']['display']["Password"];?>" type="password" name="Password"
                    id="Password">
                ...
                <input value="<?php echo $data['display']['display']["Phone"]; ?>" type="number" name="Phone" id="Phone"
                    min=0>
                ...
                <input value="<?php echo $data['display']['display']["Address"]; ?>" type="text" name="Address"
                    id="Address">
