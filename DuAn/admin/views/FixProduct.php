    ...
    <section class="page">
        ...
        <main>
            ...
            " method="post" enctype="multipart/form-data">
                ...
                <input value="<?php echo $data['display']["NameProducts"]; ?>" type="text" name="NameProducts"
                    id="NameProducts">

                <label for="Details">Details</label>
                <input value="<?php echo $data['display']["ProductDetails"]; ?>" type="text" name="Details"
                    id="Details">

                <label for="ProductDescription">Product Description</label>
                <input value="<?php echo $data['display']["ProductDescription"]; ?>" type="text"
                ...
                <input value="<?php echo $data['display']["NumberProduct"]; ?>" type="number" min=0 name="NumberProduct"
                    id="NumberProduct">
